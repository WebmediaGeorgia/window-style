	...
	private function update_attributes() {
		...
		try {
			...
			if($result1 === $id ||  $result2 === true ) {
				echo '<div class="updated notice notice-success is-dismissible thwvs-msg-updated"><p>'. __('Your changes were saved.','woocommerce-product-variation-swatches') .'</p></div>';
			}else {
