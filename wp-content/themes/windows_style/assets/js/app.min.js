...
(() => {
  ...
  !(function (e) {
    ...
    (function () {
      let e = document.querySelector(".header_burger"),
        t = document.querySelector(".burger-menu .left-part"),
        s = document.querySelector(".burger-menu");
        let h = document.querySelector(".wrapper");
      e &&
        e.addEventListener("click", () => {
          s.classList.toggle("active"), e.classList.toggle("active"),h.classList.toggle("active");
        }),
        t &&
          t.addEventListener("click", () => {
            s.classList.remove("active"), e.classList.remove("active"),h.classList.remove("active");
          });
    })(),
    new W(".my_first_slider_container", {
      modules: [R],
      navigation: {
  ...
  const X = new W(".lit_slider", {
    ...
    breakpoints: {
      ...
      601: { slidesPerView: 3 },
      1: { slidesPerView: 2, spaceBetween: 15 },
    },
  });
